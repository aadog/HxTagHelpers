...
{
    public class HxValsOptions:IOptions
    {
        private readonly Dictionary<string, object> _jsonValues = new();
        private readonly Dictionary<string, string> _jsValues = new();
        public static HxValsOptions Create()
        {
            return new HxValsOptions();
        }
        public HxValsOptions With(string key, object value)
        {
        ...
        public HxValsOptions WithJs(string key, string jsExpression)
        {
        ...
        public HxValsOptions WithObject(object obj)
        {
        ...
        public HxValsOptions WithDict(Dictionary<string, object> dict)
        {
