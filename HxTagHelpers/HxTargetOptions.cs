...
{
    public class HxTargetOptions:IOptions
    {
        public static HxTargetOptions Create()
        {
            return new HxTargetOptions();
        }
        private List<string> selectors = new List<string>();

        // 添加 this 选项
        public HxTargetOptions This()
        {
            selectors.Add("this");
            return this;
        }
        ...
        // 添加 Selector 选项
        public HxTargetOptions Selector(string selector)
        {
        ...
        public HxTargetOptions Closest(string selector)
        {
        ...
        public HxTargetOptions Find(string selector)
        {
        ...
        public HxTargetOptions Next(string selector = "")
        {
        ...
        public HxTargetOptions Previous(string selector = "")
        {
        ...
        // 添加 inherit 选项
        public HxTargetOptions Inherit()
        {
